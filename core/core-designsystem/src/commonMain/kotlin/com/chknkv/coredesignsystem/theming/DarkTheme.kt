...
fun darkThemeTokensMap(): Map<AcTokens, Color> = mapOf(
    ...
    AcTokens.ShimmerBase to Gray5,
    AcTokens.ShimmerHighlight to Gray6,

    AcTokens.SnackBarCardContainerPrimary to White1,
    AcTokens.SnackBarCardContentPrimary to Graphite1,

    AcTokens.TextBrand to Beige1,
    AcTokens.TextButtonDisabled to Graphite1,
    AcTokens.TextButtonStandard to Black1,
    AcTokens.TextButtonTransparent to White1,
    AcTokens.TextButtonTransparentNegative to Orange1,
    AcTokens.TextButtonWarning to White1,
    AcTokens.TextInverse to Black1,
    AcTokens.TextPrimary to White1,
    AcTokens.TextSecondary to White2,
    AcTokens.TextWarning to Orange1,

    AcTokens.TextFieldBackground to Gray2,
    AcTokens.TextFieldCursorColor to White1,
    AcTokens.TextFieldIcon to Graphite2,
    AcTokens.TextFieldIconDisabled to Graphite4,
    AcTokens.TextFieldLabelDisabled to Graphite4,
    ...
    AcTokens.TextFieldTextDisabled to Graphite4,
